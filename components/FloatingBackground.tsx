  ...
  return (
    <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden bg-black">
      ...
      <motion.div
        ...
        className="absolute top-0 -left-1/4 w-[1000px] h-[1000px] bg-[#4A90E2]/10 rounded-full blur-[150px]"
      />
      <motion.div
        animate={{
          scale: [1, 1.4, 1],
        ...
        className="absolute bottom-0 -right-1/4 w-[1200px] h-[1200px] bg-[#4A90E2]/10 rounded-full blur-[200px]"
      />
      ...
      <div className="absolute top-[25%] left-[60%] hidden lg:block perspective-2000">
        ...
        >
          {/* Main Ring */}
          <div className="absolute inset-0 border border-[#4A90E2]/10 rounded-full shadow-[0_0_80px_rgba(74,144,226,0.05)]" />

          {/* Middle Kinetic Ring */}
          <motion.div
            style={{ rotate: velocityRotation }}
            className="absolute w-[80%] h-[80%] border-l border-r border-[#4A90E2]/20 rounded-full"
          />

          {/* Pulsating Core - Reacts to velocity */}
          <motion.div
            style={{ scale: dynamicScale }}
            className="w-16 h-16 bg-[#4A90E2]/20 rounded-full blur-[10px] border border-[#4A90E2]/30"
          />
          ...
          <motion.div
            ...
            className="absolute w-[50%] h-[50%] border-t border-b border-[#4A90E2]/10 rounded-full"
          />
        </motion.div>
      </div>
