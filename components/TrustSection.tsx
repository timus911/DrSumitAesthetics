    ...
    return (
        <section className="py-24 border-t border-white/5 bg-neutral-950">
            <div className="container mx-auto px-6 text-center">
                <h3 className="text-gray-400 text-[10px] uppercase tracking-[0.4em] font-bold mb-12">
                    ...
                    {associations.map((assoc, i) => (
                        ...
                        >
                            <div className="border border-white/10 px-6 py-4 rounded-sm hover:border-[#4A90E2]/30 transition-colors bg-white/5">
                                <p className="text-2xl font-serif text-gray-400 group-hover:text-white transition-colors">{assoc.name}</p>
