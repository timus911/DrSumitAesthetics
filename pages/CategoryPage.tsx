...
const CategoryPage: React.FC<CategoryPageProps> = ({ type }) => {
  ...
  const descriptions = {
    ...
    "non-surgical": "Minimally invasive facial rejuvenation and skin treatments in Chandigarh — Botox, dermal fillers, microneedling and chemical peels by Dr. Sumit.",
  ...
  return (
    <div className="pt-52 pb-32">
      ...
      <div className="container mx-auto px-6">
        ...
        <h2 className="text-[#5DA9E9] text-[10px] tracking-[0.4em] uppercase font-bold mb-10">Procedures in this Domain</h2>
