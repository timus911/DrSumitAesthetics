                            ...
                            <Link to={`/concerns/${zone.id}`} className="block h-full w-full">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8 z-10">
                                    <div className="space-y-4">
                                        <h3 className="text-2xl font-serif text-white group-hover:text-[#5DA9E9] transition-colors duration-500">
                                            {zone.title}
                                        </h3>
                                        <div className="flex items-center space-x-3 text-[10px] uppercase tracking-widest text-white/40 group-hover:text-white transition-colors">
                                            <span className="font-bold">View Procedures</span>
                                            <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform duration-500 text-[#5DA9E9]" />
                                        </div>
                                    </div>
                                </div>
                            </Link>
